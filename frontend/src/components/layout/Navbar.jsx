...
import {
  ...
  FiMenu, FiX, FiLogOut, FiPackage, FiChevronDown, FiSettings
} from 'react-icons/fi';
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            {user && (user.isAdmin || user.role === 'admin') && (
              <Link to="/admin" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-soft transition-colors ml-1" title="Admin Panel">
                <FiSettings size={18} />
              </Link>
            )}
